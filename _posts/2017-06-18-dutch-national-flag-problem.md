...
**For three groups of elements** (you can look at the picture representation ![above](https://github.com/tssavita/tssavita.github.io/img/_posts/three_elements.png)). The steps would be similar, except:
